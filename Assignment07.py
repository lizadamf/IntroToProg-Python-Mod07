...
#   MLizada,11/23/2025,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
        - MLizada, 11.23.2025: Created the class.
    """
...
class FileProcessor:
    ...
    ChangeLog: (Who, When, What)
    MLizada,11.23.2025,Created Class
    """
    @staticmethod
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        MLizada,11.23.2025,Created function

        :param file_name: string data with name of file to read from
        :param student_data: list of dictionary rows to be read
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            course_name = input("Please enter the student's COURSE name: ")
